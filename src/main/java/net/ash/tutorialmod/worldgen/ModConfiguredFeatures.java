package net.ash.tutorialmod.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldBlackOpalOres = List.of(OreConfiguration.target(
                stoneReplacables, ModBlocks.BLACK_OPAL_ORE.get().defaultBlockState()
        ), OreConfiguration.target(
                deepslateReplacables, ModBlocks.DEEPSLATE_BLACK_OPAL_ORE.get().defaultBlockState()
        ));
        ...
        register(context, END_BLACK_OPAL_ORE_KEY, Feature.ORE, new OreConfiguration(endstoneReplacables, ModBlocks.ENDSTONE_BLACK_OPAL_ORE.get().defaultBlockState(), 9));
        register(context, NETHER_BLACK_OPAL_ORE_KEY, Feature.ORE, new OreConfiguration(netherrackReplacables, ModBlocks.NETHERRACK_BLACK_OPAL_ORE.get().defaultBlockState(), 9));
    }
